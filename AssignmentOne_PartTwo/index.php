...
<body style="font-family: 'Century Gothic'">
    ...
    <div class="header">
        <h1><br>Welcome To My Home Page!!</h1>
    </div>
    ...
    <div class="row">
        <div class="content">
            ...
            <ul>
                <li>Blog Page: This page containg a list of few blogs that were written.</li>
        ...
        <div class="side">
            <h1>Side Note</h1>
            <hr>
            <p class="first">This webpage is strictly focusing in disigning and doesn't actually have real functioning
                use.</p>
        </div>
    </div>
    <div class="footer">
